...
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [eisenwave/cpp-proposals](https://github.com/eisenwave/cpp-proposals)
  > My C++ proposals.
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [eisenwave/std-big-int](https://github.com/eisenwave/std-big-int)
  > Reference implementation of std::big_int for C++ (https://isocpp.org/files/papers/D4444R0.html)
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [cdervis/cppstat](https://github.com/cdervis/cppstat)
  > C and C++ Compiler Support Page
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [eisenwave/cdecl-plus](https://github.com/eisenwave/cdecl-plus)
  > Similar to cdecl.org, but with broader support for language features. Static web page which supports...
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [YARC-Official/YARG](https://github.com/YARC-Official/YARG)
  > YARG (a.k.a. Yet Another Rhythm Game) is a free, open-source, plastic guitar game that is still in d...
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [FireFox2000000/Moonscraper-Chart-Editor](https://github.com/FireFox2000000/Moonscraper-Chart-Editor)

### [johnyob](https://github.com/johnyob)
- 🌟 👤 [johnyob](https://github.com/johnyob) Starred [CleveGreen/verocaml](https://github.com/CleveGreen/verocaml)
  > Verified OxCaml for real projects and real performance.
...
---
*Last updated at 2026-08-28 23:56:41 UTC*
<!-- archive-link -->
