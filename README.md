...
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [NyaMisty/runtimectl](https://github.com/NyaMisty/runtimectl)
  > Generate Objective-C headers from dyld_shared_cache images.
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [NyaMisty/hexrays_microcode_path](https://github.com/NyaMisty/hexrays_microcode_path)
  > Navigate like XPath in HexRays microcode
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [NyaMisty/docker-wine-dotnet](https://github.com/NyaMisty/docker-wine-dotnet)
  > Wine with Microsoft dotnet
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [NyaMisty/docker-ida](https://github.com/NyaMisty/docker-ida)
...
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [cube0x8/PEMutator](https://github.com/cube0x8/PEMutator)
  > A Rust, format-aware, mutator for PE binary format.
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [cube0x8/LibAFL-BDCore-Fuzzer](https://github.com/cube0x8/LibAFL-BDCore-Fuzzer)
  > A LibAFL snapshot-based fuzzer for the Linux-porting of the BitDefender engine.
- 🌟 👤 [jevinskie](https://github.com/jevinskie) Starred [cube0x8/BDClient](https://github.com/cube0x8/BDClient)
...
---
*Last updated at 2026-04-24 21:55:35 UTC*
